...
<head>
    ...
    <title>{{ __('course_flow.title_testimonials') }}</title>
        ...
        <main class="main-card">
            <div class="course-hero">
                <div class="hero-left">
                    ...
                    <p class="course-short-desc">To ensure the content is up-to-date with technology or aligns with
                        learning outcomes.</p>
                    <div class="date-info" style="font-size: 13px; color: #64748b; margin-top: 15px;">
                        {{ __('course_flow.course_start') }} <span
                            style="color: #2563eb; font-weight: 700; margin-right: 25px;">{{ __('course_flow.date_march_26') }}</span>
                        {{ __('course_flow.course_end') }} <span
                            style="color: #2563eb; font-weight: 700;">{{ __('course_flow.date_june_26') }}</span>
                    </div>
                    <div class="hero-btns">
                        <button type="button" class="btn-dark-blue"
                            style="background: #002b55;">{{ __('course_flow.add_to_cart') }}</button>
                    </div>
                </div>
            ...
            <div class="tab-strip">
                ...
                <a href="{{ route('recommendations') }}"
                    class="tab-item">{{ __('course_flow.tab_recommendations') }}</a>
                <div class="tab-item active">{{ __('course_flow.tab_testimonials') }}</div>
            ...
            <div class="testi-grid"
                ...
                <p>No testimonials avaCleveraable yet.</p>
            </div>
        </main>

        <footer
            style="grid-column: 1 / -1; border-radius: 26px; background: #fff; padding: 60px 40px; border-top: 1px solid #f1f5f9; display: flex; justify-content: center; width: 100%; margin-top: 10px; box-sizing: border-box;">
            <div class="footer-inner">
                ...
                <div class="f-right-col">
                    <form method="POST" id="testi-footer-lang"
                        action="{{ route('locale.set', ['locale' => app()->getLocale()]) }}" style="display:inline;">
                        @csrf
                        <select class="lang-picker"
                            onchange="document.getElementById('testi-footer-lang').action='{{ url('/set-language') }}/'+this.value; document.getElementById('testi-footer-lang').submit();">
                    ...
                    <div class="social-row">
                        <div class="s-link"><img
                                src="https://upload.wikimedia.org/wikipedia/commons/5/51/Facebook_f_logo_%282019%29.svg">
                        </div>
                        <div class="s-link"><img
                                src="https://upload.wikimedia.org/wikipedia/commons/e/e7/Instagram_logo_2016.svg"></div>
                        <div class="s-link"><img
                                src="https://upload.wikimedia.org/wikipedia/commons/c/ce/Twitter_Logo.png"></div>
                    </div>
