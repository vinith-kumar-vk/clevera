    ...
    <div class="shared-shell">
                ...
                <div class="flex-container">
                    ...
                    <div style="flex: 2;">
                        <div class="section-card">
                            ...
                            <div class="empty-row">
                                ...
                                <button class="btn-enrol" onclick="window.location.href='{{ route('courses') }}'">+
                                    Enrol Now</button>
                            </div>
                        </div>
                    </div>
                    ...
                    <div style="flex: 1;">
                        <div class="section-card">
                            ...
                            <div class="empty-row"
                                style="flex-direction: column; align-items: flex-start; gap: 10px; border:none;">
                ...
                <div class="section-card">
                    ...
                    <div class="notes-grid">
                        <div class="note-column">
                            ...
                            <div
                                style="background:#fff; border-radius:10px; height:40px; border:1px dashed #e2e8f0; display:flex; align-items:center; justify-content:center; color:#cbd5e0; font-size:20px;">
                                +</div>
                        </div>

                        <div class="note-column" style="background:transparent; border:1px dashed #e2e8f0;">
                            <div class="add-task-form" style="border:none;">
                                <input type="text" placeholder="Create list title..."
                                    style="font-weight:600; font-size:14px;">
                                <div class="form-btns">
                                    <button class="btn-add">+ Add Task</button>
                                    <button class="btn-cancel"
                                        style="background:#fff; border:1px solid #e2e8f0;">Cancel</button>
                                </div>
                            </div>
                        </div>
                    </div>
        ...
        <footer>
            <div class="footer-brand">
                ...
                <p>Learn anytime and anywhere<br>from il career skills</p>
            </div>
