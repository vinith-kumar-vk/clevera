    ...
    <div class="wrapper">
                    ...
                    <div class="hero-left">
                        ...
                        <div class="hero-btns" style="margin-top:25px;">
                            <button class="btn-dark-blue"
                                style="background: #002b55; padding:10px 25px; border-radius:10px; color:#fff; border:none; font-weight:700; cursor:pointer;">Add
                                to Cart</button>
                        </div>
                    </div>
                            ...
                            <div class="mod-item {{ $index === 0 ? 'expanded' : '' }}">
                                <div class="mod-header" onclick="this.parentElement.classList.toggle('expanded')">
                                    <div class="mh-left-col">
                                        <h3>{{ $mod['title'] }}</h3>
                                        <p>{{ $mod['hours'] }} {{ __('modules_page.hours_unit') }} •
                                ...
                                <div class="mod-expanded-content" style="display: {{ $index === 0 ? 'block' : 'none' }};">
                                    ...
                                    <div class="lesson-list">
                                        <div class="lesson-row"><strong>{{ __('modules_page.row_teaching') }}</strong>
                                            <span>{{ $mod['activities'] }}</span></div>
                                        <div class="lesson-row"><strong>{{ __('modules_page.row_media') }}</strong>
                                            <span>{{ $mod['media'] }}</span></div>
                                        <div class="lesson-row"><strong>{{ __('modules_page.row_teacher') }}</strong>
                                            <span>{{ $mod['teacher'] }}</span></div>
                                    </div>
                                </div>
                            </div>
                        @endforeach
        ...
        <footer>
            <div class="footer-inner">
                <div class="f-brand">
                    <div class="f-logo-circle"><img src="{{ asset('images/logo.png') }}" alt=""></div>
                ...
                <div class="f-right-col">
                    <form method="POST" id="modules-footer-lang"
