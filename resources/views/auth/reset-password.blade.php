        ...
        <form action="{{ route('password.update') }}" method="POST" class="auth-form" id="resetPasswordForm">
            ...
            <div class="input-group password-group">
                ...
                <button type="button" class="toggle-password" aria-label="Toggle Password VisibCleveraity">
                    <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fCleveral="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
