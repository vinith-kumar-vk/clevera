...
<body class="home-page">
    ...
    <header class="home-header">
        <div class="home-header-inner">
            ...
            <div class="header-right">
                ...
                <div class="home-lang-switch" aria-label="Language" style="display: none !important;">
                    <form method="POST" action="{{ route('locale.set', ['locale' => 'en']) }}">
                        @csrf
                        <button type="submit"
                            class="home-lang-btn {{ app()->getLocale() === 'en' ? 'active' : '' }}">{{ __('home.lang_english') }}</button>
                    </form>
                    <form method="POST" action="{{ route('locale.set', ['locale' => 'th']) }}">
                        @csrf
                        <button type="submit"
                            style="display:none;" class="home-lang-btn {{ app()->getLocale() === 'th' ? 'active' : '' }}">{{ __('home.lang_thai') }}</button>
                    </form>
                </div>
    ...
    <div class="mobile-side-nav" id="mobileSideNav">
        ...
        <div class="mobile-nav-body">
            ...
            <div class="home-lang-switch" style="display:none !important; padding: 0 20px 16px; justify-content: center;">
                <form method="POST" action="{{ route('locale.set', ['locale' => 'en']) }}">
                    @csrf
                    <button type="submit"
                        class="home-lang-btn {{ app()->getLocale() === 'en' ? 'active' : '' }}">{{ __('home.lang_english') }}</button>
        ...
        <div class="wide-range-inner">
            ...
            <div class="wide-range-left">
                <h2 class="section-heading">
                    {{ __('home.wide_range_l1') }}<br>{{ __('home.wide_range_l2') }}<br>{{ __('home.wide_range_l3') }}
                </h2>
                <div class="wide-range-images-custom">
                    <!-- Girl Image -->
                    <div class="wr-img-block wr-img-1">
                        <img src="{{ asset('images/Artboard 2.jpg') }}" alt="{{ __('home.alt_learning') }}">
                    </div>
                    <!-- Boy Image (Staggered) -->
                    <div class="wr-img-block wr-img-2">
                        <img src="{{ asset('images/Artboard 7.jpg') }}" alt="{{ __('home.alt_deep_focus') }}">
                    </div>
                </div>
            </div>
    ...
    <section class="course-section">
        <div class="course-section-header">
            ...
            <div style="display: flex; align-items: center; gap: 20px;">
                <a href="{{ route('free.courses') }}"
                    style="font-size: 14px; font-weight: 700; color: #003a70; text-decoration: none;">{{ __('home.view_all') }}</a>
        ...
        <div class="course-cards-row" style="display: grid; grid-template-columns: repeat(4, 1fr); gap: 24px">
            ...
            @foreach($free_course_imgs as $index => $img)
                ...
                @if($index == 0)
                    <a href="{{ route('courses') }}" class="vertical-course-card"
    ...
    <section class="course-section" style=" border-top: none;">
        <div class="course-section-header">
            ...
            <div class="carousel-arrows">
                <button class="arrow-btn"
                    style="border-color: #bfdbfe; color: #3b82f6; background: #eff6ff;">â€¹</button>
                <button class="arrow-btn"
                    style="border-color: #bfdbfe; color: #3b82f6; background: #eff6ff;">â€º</button>
            </div>
        </div>
        ...
        <div class="home-footer-inner">
            <div class="footer-brand-section">
                <div class="footer-logo-circle">
                    <img src="{{ asset('images/logo.png') }}" alt="il Logo">
                </div>
            ...
            <div class="footer-right-section">
                <form method="POST" id="home-footer-lang-form"
                    action="{{ route('locale.set', ['locale' => app()->getLocale()]) }}" class="footer-lang-form"
                    style="display:none !important;">
                    @csrf
                    <select class="footer-lang-select"
                        onchange="document.getElementById('home-footer-lang-form').action='{{ url('/set-language') }}/'+this.value; document.getElementById('home-footer-lang-form').submit();">
