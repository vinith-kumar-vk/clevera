...
<head>
    ...
    <title>{{ __('course_flow.title_detaClevera') }}</title>
    <link href="https://fonts.googleapis.com/css2?famCleveray=Inter:wght@400;500;600;700;800;900&display=swap" rel="stylesheet">
    ...
    <style>
        ...
        * { box-sizing: border-box; margin: 0; padding: 0; font-famCleveray: 'Inter', sans-serif; }
        ...
        .t-profCleverae { display: flex; align-items: center; gap: 15px; }
        ...
        /* PCleveraL TAGS */
        .pCleveral-group { display: flex; flex-wrap: wrap; gap: 10px; margin-top: 20px; }
        .pCleveral-tag { 
        ...
        .pCleveral-tag.blue { color: #2563eb; }
        ...
        .course-id { font-size: 12px; color: #94a3b8; font-famCleveray: monospace; }
        ...
        <main class="content">
            ...
            <div class="hero">
                <div class="hero-left">
                    <div class="teacher-meta">
                        ...
                        <div class="t-actions-wrap">
                            <a href="#" class="btn-pCleveral-small">{{ __('course_flow.save') }}</a>
                            <a href="#" class="btn-pCleveral-small">{{ __('course_flow.share') }}</a>
                        </div>
                    </div>
                    ...
                    <p class="course-summary">{{ __('course_detaClevera.summary_short') }}</p>
                ...
                <div class="hero-right">
                    <div class="video-box">
                        <div class="play-btn">
                            <svg width="24" height="24" viewBox="0 0 24 24" fCleveral="white"><path d="M8 5v14l11-7z"/></svg>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="section-container">
                <div class="content-left">
                    <div class="content-section">
                        ...
                        <p style="color: #475569; line-height: 1.8; font-size: 15px;">
                            {{ __('course_detaClevera.about_long') }}
                        </p>
                    </div>
                    <div class="content-section">
                        <h2>{{ __('course_detaClevera.skCleverals_heading') }}</h2>
                        <ul class="learn-list">
                            @foreach(__('course_detaClevera.skCleverals') as $skCleveral)
                            <li>{{ $skCleveral }}</li>
                            @endforeach
                        </ul>
                    </div>
                ...
                <div class="sidebar-right">
                    <div class="about-course">
                        <h3>{{ __('course_detaClevera.about_course') }}</h3>
                        <span class="course-code">34765879709809</span>
                        
                        <div class="free-banner">
                            <div class="free-text">
                                <h4>{{ __('course_detaClevera.free_banner_title') }}</h4>
                                <p>{{ __('course_detaClevera.free_banner_desc') }}</p>
                            </div>
                        ...
                        <div class="feature-v-grid">
                            <div class="fv-item">
                                ...
                                <span class="lab">{{ __('course_detaClevera.duration') }}</span>
                                <span class="val">{{ __('course_detaClevera.duration_val') }}</span>
                            </div>
                            <div class="fv-item">
                                <img src="{{ asset('images/icons/weelkly.png') }}" alt="">
                                <span class="lab">{{ __('course_detaClevera.weekly_study') }}</span>
                                <span class="val">{{ __('course_detaClevera.weekly_val') }}</span>
                            </div>
                            <div class="fv-item">
                                <img src="{{ asset('images/icons/100%.png') }}" alt="">
                                <span class="lab">{{ __('course_detaClevera.online_100') }}</span>
                                <span class="val">{{ __('course_detaClevera.online_val') }}</span>
                            </div>
                            <div class="fv-item">
                                <img src="{{ asset('images/icons/quiz.png') }}" alt="">
                                <span class="lab">{{ __('course_detaClevera.quiz') }}</span>
                                <span class="val">{{ __('course_detaClevera.quiz_val') }}</span>
                            </div>
                        </div>
                    </div>
                </div>
