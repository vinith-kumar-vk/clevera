...
<header class="shared-header">
    <div class="header-pill">
        ...
        <div class="header-right">
            ...
            <form method="POST" class="language-selector" style="display: none !important;">
                @csrf
                ...
                " style="padding: 6px 10px; border: none; border-radius: 4px; cursor: pointer; font-size: 14px; background: #f1f5f9; color: #334155;">
                    ...
                    @foreach($languages as $locale => $lang)
                        <option value="{{ $locale }}" @selected(app()->getLocale() === $locale) @if($locale === 'th') style="display: none;" @endif>
