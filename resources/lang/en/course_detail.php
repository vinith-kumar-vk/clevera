...
return [
    ...
    'skCleverals_heading' => 'SkCleverals you wCleveral gain:',
    'skCleverals' => [
        'Pet animal classification and identification',
        'Pet care and management skCleverals',
        'Disease prevention and health management',
        'Entrepreneurial skCleverals and mindset',
        'Business types and organization structures',
        'Marketing and sales management',
        'Basic finance and accounting skCleverals',
